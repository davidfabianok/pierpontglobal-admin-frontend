            ...
            content={
                <div className="p-24 max-w-2xl mx-auto">
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        component={require('main/content/components/material-ui/material-ui-examples/bottom-navigation/SimpleBottomNavigation.jsx').default}
                        raw={require('!raw-loader!main/content/components/material-ui/material-ui-examples/bottom-navigation/SimpleBottomNavigation.jsx')}
                    /></Typography>
                    ...
                    <Typography className="mb-16" component="div"><FuseExample
                        className="my-24"
                        component={require('main/content/components/material-ui/material-ui-examples/bottom-navigation/LabelBottomNavigation.jsx').default}
                        raw={require('!raw-loader!main/content/components/material-ui/material-ui-examples/bottom-navigation/LabelBottomNavigation.jsx')}
                    /></Typography>
