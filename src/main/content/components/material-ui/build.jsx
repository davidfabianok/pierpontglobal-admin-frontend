...
const routesFilePath = path.resolve(rootDirectory, './MaterialUIRoutes.jsx');
const navigationFilePath = path.resolve(rootDirectory, './MaterialUINavigation.jsx');
...
function writePage(file)
{
    ...
    fs.writeFileSync(path.resolve(pagesDirectory, fileName + '.jsx'), content);
}
