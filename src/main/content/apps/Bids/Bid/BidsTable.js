...
import * as Actions from 'main/content/apps/Bids/store/actions';
...
class BidsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/Bids/Bid/' + item.id + '/' + item.handle);
    };
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(BidsTable)));
