...
import {
  Avatar, Divider, Icon, List, ListItem, ListItemText, Paper, Typography,
          ...
          <Paper elevation={1} className="rounded-8">
            ...
            <List>
              ...
              >
                ...
                <ListItemText className="truncate pr-0" primary="All contacts" disableTypography />
              </ListItem>
              <ListItem
                button
                component={NavLink}
              ...
              >
                ...
                <ListItemText className="truncate pr-0" primary="Frequently contacted" disableTypography />
              </ListItem>
              <ListItem
                button
                component={NavLink}
              ...
              >
                ...
                <ListItemText className="truncate pr-0" primary="Starred contacts" disableTypography />
              </ListItem>
            </List>
          </Paper>
        </FuseAnimate>
