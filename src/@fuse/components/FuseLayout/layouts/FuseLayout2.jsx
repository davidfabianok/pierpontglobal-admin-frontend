...
import {
  AppBar, Paper, Hidden, Icon, IconButton, Toolbar, Drawer, MuiThemeProvider,
...
class FuseLayout2 extends Component {
  render() {
    const {
      classes, toolbar, footer, navbarHeader, navbarContent, settings, navbar, navbarOpenMobile, navbarCloseMobile, children, leftSidePanel, rightSidePanel, contentWrapper,
    } = this.props;
